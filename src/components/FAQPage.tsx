      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          >
            ...
            <div className="p-5 rounded-2xl bg-blue-50/10 border border-blue-100/30 space-y-3">
              <div className="p-2 rounded-lg bg-blue-900 text-white w-fit">
            ...
            {/* Visual Support Card */}
            <div className="rounded-2xl overflow-hidden border border-slate-200/80 p-1 bg-[#FAF9F5] shadow-3xs">
              ...
              return (
                <div
                  ...
                  className={`rounded-2xl border transition-all ${
                    isExpanded
                      ? 'border-teal-600/30 bg-[#FAF9F5] shadow-sm'
                      : 'border-slate-200/80 hover:border-slate-300 bg-[#FAF9F5]'
                  }`}
